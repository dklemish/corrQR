...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(corr_qr_fit(par_, x_, y_, hyper_, dim_, A_, R_, LOGDET_, LPGRID_, tauG_, muV_, SV_, blocks_, blockSizes_, dmcmcpar_, imcmcpar_));
    return __result;
END_RCPP
}
// devianceCalc
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< SEXP >::type LPGRID_(LPGRID_SEXP);
    Rcpp::traits::input_parameter< SEXP >::type tauG_(tauG_SEXP);
    __result = Rcpp::wrap(devianceCalc(pars_, x_, y_, hyper_, dim_, A_, R_, LOGDET_, LPGRID_, tauG_));
    return __result;
END_RCPP
}
